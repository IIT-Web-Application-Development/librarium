...
var normalOnClick = function(){
	...
	$("#calculateBudget").unbind().click(function(){
		var rentCost = document.getElementById("bookRentCost");
		var totalBal = document.getElementById("totalBalance");
		var remainingBal = document.getElementById("remainingBalance");
		if(totalBal.value ==''){
			alert("Please enter valid value....");
		}
		else{
		 	remainingBal.innerHTML = "Your remaining balance is: $" + (totalBal.value - Number(rentCost.value));
		}
